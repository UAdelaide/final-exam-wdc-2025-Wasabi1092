...
((SELECT dog_id FROM Dogs WHERE name='Bella'), '2025-06-10 08:00:00', 45, 'Beachside Ave', 'open'),
((SELECT dog_id FROM Dogs WHERE name='Bobby'), '2025-06-10 08:00:00', 15, 'Parklands', 'open'),
((SELECT dog_id FROM Dogs WHERE name='Richie'), '2025-06-10 08:00:00', 60, 'Parklands', 'open'),
((SELECT dog_id FROM Dogs WHERE name='Monty'), '2025-06-10 08:00:00', 30, 'Parklands', 'open'),
