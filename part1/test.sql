...
((SELECT dog_id FROM Dogs WHERE name='Bobby'), '2025-06-10 08:00:00', 15, 'Glenelg Beach', 'open'),
((SELECT dog_id FROM Dogs WHERE name='Richie'), '2025-06-10 08:00:00', 60, 'Parklands', 'open'),
((SELECT dog_id FROM Dogs WHERE name='Monty'), '2025-06-10 08:00:00', 30, 'Beachside Ave', 'open'),
